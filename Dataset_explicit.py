...
class Dataset_explicit(object):
    ...
    def __init__(self, path):
        ...
        Constructor
        '''
        self.trainMatrix, self.user_dict, self.item_dict,self.train_num_rated_users,self.num_users,self.num_items= self.load_explicit_rating_file_as_list(
            path + ".train.rating")
        self.testRatings, _, _, self.test_num_rated_users,_,_= self.load_explicit_rating_file_as_list(
            path + ".test.rating")
    ...
    def load_explicit_rating_file_as_list(self, filename):
        ...
        return ratingList, user_dict, item_dict, num_rated_users,num_users,num_items
