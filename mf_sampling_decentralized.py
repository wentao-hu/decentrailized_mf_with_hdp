...
def main():
    ...
    item_privacy={args.item_privacy} results={args.filename} log={args.logfile} threshold={args.threshold}"""
    ...
    try:
        for epoch in range(args.epochs):
            # Private Training
            train_mse= model.fit(args.threshold,sampled_train_rating_matrix,args.learning_rate,num_rated_users)
